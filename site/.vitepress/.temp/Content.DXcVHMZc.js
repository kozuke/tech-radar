...
const siteData = deserializeFunctions(JSON.parse('{"lang":"ja-JP","dir":"ltr","title":"Tech Radar","description":"技術トレンドを自動収集・要約","base":"/tech-radar/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","nav":[{"text":"ホーム","link":"/"},{"text":"タグ","link":"/tags/"},{"text":"About","link":"/about"}],"socialLinks":[{"icon":"github","link":"https://github.com/your-username/tech-radar"}],"footer":{"message":"Powered by VitePress & OpenRouter AI","copyright":"© 2026 Tech Radar"},"search":{"provider":"local","options":{"translations":{"button":{"buttonText":"検索","buttonAriaLabel":"検索"},"modal":{"noResultsText":"結果が見つかりません","resetButtonTitle":"リセット","footer":{"selectText":"選択","navigateText":"移動","closeText":"閉じる"}}}}},"outline":{"label":"目次","level":[2,3]},"docFooter":{"prev":"前の記事","next":"次の記事"},"lastUpdated":{"text":"最終更新","formatOptions":{"dateStyle":"short","timeStyle":"short"}}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
